...
enum class WeekendPattern(
    ...
    FRI_SUN(1, DayOfWeek.FRIDAY, DayOfWeek.SUNDAY, 0, "Fr → So"),
    THU_SUN(2, DayOfWeek.THURSDAY, DayOfWeek.SUNDAY, 0, "Do → So"),
    FRI_MON(3, DayOfWeek.FRIDAY, DayOfWeek.MONDAY, 1, "Fr → Mo"),
    THU_MON(4, DayOfWeek.THURSDAY, DayOfWeek.MONDAY, 1, "Do → Mo"),
    ;
